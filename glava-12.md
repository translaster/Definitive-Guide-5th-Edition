...
<table border="1" width="100%" cellpadding="5">
  <tr>
    <td>
    <p><img src="pics/note.png" height="100" align="left">С точки зрения бизнеса, вы должны сказать своим агентам, чтобы они очистили все звонки из очереди, прежде чем выходить из системы в течение дня. Если вы обнаружите, что в конце дня в очереди много вызовов, возможно, вы захотите продлить чью-то смену, чтобы обслужить их. В противном случае, они просто добавят вам стресса, когда перезвонят на следующий день в худшем настроении.</p>
    <p>Вы можете использовать <code>GotoIfTime()</code> ближе к концу дня, чтобы перенаправить абонентов на голосовую почту или другое подходящее место в вашем диалплане, пока ваши агенты очищают все оставшиеся вызовы в очереди.</p>
    </td>
  </tr>
</table>
