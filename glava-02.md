...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left">Provides the Asterisk Gateway Interface (see <a href="glava-18.md">Глава 18</a>)</td>
    </tr>
    <tr>
    ...
    <tr>
      <td style="text-align:left">
        ...
        <p><a href="https://learning.oreilly.com/library/view/asterisk-the-definitive/9781492031598/ch02.html%22%20/l%20%22idm46178409412232-marker">b</a> Для использования требуется отдельно лицензируемый продукт.</p>
      </td>
...
В Asterisk спул используется для хранения временных элементов, таких как голосовые сообщения, записи вызовов,<sup><a href="#sn6">6</a></sup> файлы вызовов и так далее.
...
<ol>
<li id="sn1">Х орошим показателем того, что вы работали с традиционными УАТС, является наличие большой мозоли на лбу, полученной в результате слишком большого количества ударов головой о кирпичную стену, чтобы сосчитать.</li>

<li id="sn2"> Эта команда доступна как часть процесса установки. Мы обсудим использование `menuselect` в главе об установке.</li>
...
<li id="sn6"> Не подробные записи вызовов (CDRs), а скорее аудиозаписи вызовов, генерируемых `MixMonitor()` и связанными приложениями.</li>
</ol>
