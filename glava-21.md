...
<a name="snt1-a">a</a> Это не теория. Это случилось и с нами. Это было совсем невесело.

<a name="snt1-b">b</a> Это не так рискованно, как кажется отлаживать, так как это займет месяцы, чтобы заполнить жесткий диск, но опасность заключается в том, что это произойдет, скажем, через год, когда вы находитесь на летних каникулах, и сразу не будет очевидно, в чем проблема. Совсем не весело.
Предупреждение
